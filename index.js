...
module.exports = syaa = async (syaa, mek) => {
  try {
    ...
    mess = {
      ...
      success: "Success√ jangan lupa follow ig _ lanox _",
    ...
    const ftroli = {
      key: {
        ...
        remoteJid: "6282292838634-15512131770@g.us",
      },
      message: {
        orderMessage: {
          itemCount: 10,
    ...
    const fvn = {
      key: {
        participant: `0@s.whatsapp.net`,
        ...(from ? { remoteJid: "6282292838634-15512131770@g.us" } : {}),
      },
      message: {
        audioMessage: {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "6282292838634@s.whatsapp.net";
...
`;
        sendButImage(from, menu, "by @AlanGanz ❤️", thumb, [
          {
      ...
      case "owner":
        ...
        sendButMessage(
          ...
          [
            ...
            {
              buttonId: `${prefix}igstalk _lanox_`,
              buttonText: {
...
case 'fftext': 				
				...
				syaa.sendMessage(from, dapuhy, image, { quoted: mek, caption: 'Nih Jangan Lupa Follow Ig @_ lanox _' })
				break
case 'kbbi':	
...
case "report":
                    ...
                    syaa.sendMessage('6282292838634@s.whatsapp.net', options, text, {quoted: mek})
...
syaa.sendMessage(from, `Alan`, MessageType.extendedText,{
 quoted: {
key: {
...
break
					case "narutopekok":
					  if (args.length == 0) return reply(`Usage: ${prefix + command} text\nExample: ${prefix}coffecup alan`)
                    babi = args.join(" ")
                    reply("wait")
                    buffer = await getBuffer(`https://hardianto-chan.herokuapp.com/api/photooxy/coffe-cup?apikey=hardianto&text=${babi}`)
                    syaa.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan lupa follow ig @_ LANOX _', quoted: mek})
                break
case "attp":
  if (isBanned) return reply(mess.ban)
...
if (isBanned) return reply(mess.ban)
  ...
  contoh /tts id Alan Ganteng`)
  break
case 'tts'://FIXED BY Alan!!!!
if (isBanned) return reply(mess.ban)
...
case 'donat':
  ...
  ├─ ❏ 082292838634
  ├─ ❏ *INSTAGRAM*
  └─ ❏ https://www.instagram.com/_lanox_`)
...
• ${prefix}fitnah
• ${prefix}fitnahpc
• ${prefix}kontak 6282292838634|alan
• ${prefix}jadian
• ${prefix}
• ${prefix}tod
• ${prefix}truth
...
case "peraturan2":
					// Fix Case by Alan
					sya = await getBuffer(`https://telegra.ph/file/b12df589bd2fa9c916d8a.jpg`)
					syaa.sendMessage(from, sya, image, { quoted: mek, caption: `alan bot merupakan suatu program bot whatsapp, yang menggunakan engine nodejs v14.x.x
Adapun ketentuan untuk memakai alan bot. :
...
case "textburn":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}textburn Alan`)
				reply('Bentar lagi di proses')
...
case "quote":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}quote Alan`)
				reply('Bentar lagi di proses')
kontol = body.slice(7)
...
case "wooden":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}wooden Alan`)
				reply('Bentar lagi di proses')
kontol = body.slice(8)
...
case "roses":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}roses Alan`)
				reply('Bentar lagi di proses')
kontol = body.slice(7)
...
case "pubglogo":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}pubglogo alan|Ganz`)
...
break
case "waifum":
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix + command}Alan|Ganz`)
				reply(mess.wait)
     ct = body.slice(8)
     memek1 = ct.split("|")[0];
     memek2 = ct.split("|")[1];
     ...
     break
case "ctahta":
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}ctahta Alan|Ganteng|`)
				reply('Sebentar lagi di buat')
     ct = body.slice(9)
     memek1 = ct.split("|")[0];
     memek2 = ct.split("|")[1];
...
case "hartatahta":
         ...
         break   
case "pppppp":
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}glitch Alan|Ganz`)
				reply('Sebentar lagi di buat')
     ct = body.slice(8)
     memek1 = ct.split("|")[0];
     memek2 = ct.split("|")[1];
...
///𝑃𝐼𝑅𝑇𝐸𝐾
 case "virtekeun":
        if (!isOwner && !mek.key.fromMe) return reply(mess.own)    
   reply(`🇮🇮🇩⃢⃞⃝     🇮🇩⃢⃞⃝۝̶ *VIRUS 🇮🇩⃢⃞⃝۝̶ LANOX۝⃢⃞̶*۝⃢⃞̶🇮🇩
🇮🇩⃢⃞⃝۝̶ *LANOX*۝⃢⃞̶🇮🇩
🇮🇩⃢⃞⃝۝̶ *ALAN'*۝⃢⃞̶🇮🇩
*9999999* *ผิดุท้่                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          
...
case 'tiktokvid':
    ...
    Follower: ${i.result.stats.followerCount}`;
     ...
     /* case "waifu":
      ...
      case "aeshtetic":
      case "wallpaperanime":
        sendButMessage(from, `Random Image by @Alanbotz`, `press the button below`, [
          {
...
case "bajingan":
   ...
   reply("Succes Buat Fitur Bajingan, Jangan lupa FOLLOW IG owner : _ LANOX _")
   break
case "darkjokes":
  case "darkjoke":
   if (isBanned) return reply(mess.ban)
...
${
  descOwner
    ...
    : "*Desc diubah oleh* : -"
        ...
        break
        case "Hai":
                  sendButMessage(from, `hai juga kakak ada yg bisa ${namabot} bantu?`, `Silahkan Pencet menu dibawah`, [
            {
              buttonId: `${prefix}menu`,
              buttonText: {
                displayText: `MENU`,
        ...
        break
        case "Halot":
                  sendButMessage(from, `halo juga kak, ada apa kak?ada yg bisa ${namabot} bantu?`, `Silahkan Pencet menu dibawah`, [
            {
              buttonId: `${prefix}menu`,
              buttonText: {
                displayText: `MENU`,
        ...
        break
if (budy.startsWith('@6282292838634')){
...
reply("Waalaikumsalam Wr.Wb halo kak saya bot")
break
        case "Bot":
                  sendButMessage(from, `Iyaaa ada apa kak?ada yg bisa ${namabot} bantu?`, `Silahkan Pencet menu dibawah`, [
            {
